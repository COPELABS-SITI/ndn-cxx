...
public:
   ...
   * @return KeyId
   *
   * In certificate format v2.0, key Id is the last second component of the key name.
   *
   * For example, given a certificate name:
   *   /edu/ucla/cs/yingdi/%03%CD...%F1/KEY/%FD%d2...%8E
   *
   * the corresponding key name is:
   *   /edu/ucla/cs/yingdi/%03%CD...%F1/KEY
   *   \_________________/\___________/
   *      Identity Name       Key Id
   *
   * @sa doc/spec/certificate-format.rst
   */
  name::Component
  getKeyId() const;
