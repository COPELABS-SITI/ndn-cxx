...
BOOST_AUTO_TEST_SUITE(SecurityCertificate)
...
const uint8_t CERT[] = {
  0x06, 0xFD, 0x01, 0xB5, 0x07, 0x2D, 0x08, 0x03, 0x6E, 0x64, 0x6E, 0x08, 0x05, 0x73, 0x69, 0x74,
  0x65, 0x31, 0x08, 0x11, 0x6B, 0x73, 0x6B, 0x2D, 0x31, 0x34, 0x31, 0x36, 0x34, 0x32, 0x35, 0x33,
  0x37, 0x37, 0x30, 0x39, 0x34, 0x08, 0x03, 0x4B, 0x45, 0x59, 0x08, 0x07, 0xFD, 0x00, 0x00, 0x01,
  0x49, 0xC9, 0x8B, 0x14, 0x09, 0x18, 0x01, 0x02, 0x19, 0x04, 0x00, 0x36, 0xEE, 0x80, 0x15, 0xA0,
  ...
  
};

BOOST_AUTO_TEST_CASE(Construction)
{
  Block block(CERT, sizeof(CERT));
  Certificate certificate1(block);
...
BOOST_AUTO_TEST_CASE(GetterSetter)
{
  ...
  certificate.setName("/ndn/site1/ksk-1416425377094/KEY/%FD%00%00%01I%C9%8B");
  ...
  Name keyLocatorName("/ndn/site1/ksk-2516425377094/KEY");
  KeyLocator keyLocator(keyLocatorName);
  signatureInfo.setKeyLocator(keyLocator);

  time::system_clock::TimePoint notBefore = time::fromIsoString("20150819T120000");
  time::system_clock::TimePoint notAfter = time::fromIsoString("20150823T120000");
  ValidityPeriod period(notBefore, notAfter);
  ...
  BOOST_CHECK_EQUAL(certificate.isInValidityPeriod(time::fromIsoString("20150821T130000")), true);
  BOOST_CHECK_EQUAL(certificate.isInValidityPeriod(time::fromIsoString("20150921T130000")), false);
